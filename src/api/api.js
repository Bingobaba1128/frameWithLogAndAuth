...
export const getToken = (code,ajax) => {
    return (
        // ajax.post("http://120.78.186.60:8087/oauth/token?grant_type=authorization_code&client_id=erp_v&client_secret=erpVietnam&redirect_uri=http://120.78.186.60:8119/home&code=" + code)
        ...
        ajax.post("http://120.78.186.60:8087/oauth/token?grant_type=authorization_code&client_id=erp_v&client_secret=erpVietnam&redirect_uri=" + baseUrl1 + "/home&code=" + code)
    )
}

export const autologin = (data,ajax) => {
    return (
        ajax.get(baseUrl1 + "/ERP/login?" + data)
    )
}
